...
@Mod("sonicmod")
public class SonicmodMod {
	public static final Logger LOGGER = LogManager.getLogger(SonicmodMod.class);
	public static final String MODID = "sonicmod";

	public SonicmodMod(IEventBus modEventBus) {
