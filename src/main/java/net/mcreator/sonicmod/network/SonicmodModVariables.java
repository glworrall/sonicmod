...
public class SonicmodModVariables {
	...
	public static void init(FMLCommonSetupEvent event) {
		SonicmodMod.addNetworkMessage(SavedDataSyncMessage.TYPE, SavedDataSyncMessage.STREAM_CODEC, SavedDataSyncMessage::handleData);
	}
	...
	public static class WorldVariables extends SavedData {
		public static final String DATA_NAME = "sonicmod_worldvars";
	...
	public static class MapVariables extends SavedData {
		public static final String DATA_NAME = "sonicmod_mapvars";
	...
	public record SavedDataSyncMessage(int dataType, SavedData data) implements CustomPacketPayload {
		public static final Type<SavedDataSyncMessage> TYPE = new Type<>(ResourceLocation.fromNamespaceAndPath(SonicmodMod.MODID, "saved_data_sync"));
